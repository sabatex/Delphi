...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQOfficeColorPanel.pas,v 1.28 2005/11/01 20:47:11 asnepvangers Exp $
...
uses
  ...
  SysUtils, Classes,
  QWindows, QGraphics, QControls, QForms, QButtons, QDialogs,QExtCtrls, 
  Qt, 
  JvQTypes, JvQExControls, JvQSpeedButton,  JvQPanel;
