...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQStartMenuButton.pas,v 1.1 2004/05/15 21:48:56 asnepvangers Exp $

{$I jvcl.inc}
{$I windowsonly.inc}

unit JvQStartMenuButton;

interface

uses
  Windows, SysUtils, Classes, QGraphics, QControls, QMenus, QImgList,
  JvQTypes, JvQButton, JvQComputerInfoEx;
