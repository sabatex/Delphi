...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQDynControlEngineTools.pas,v 1.2 2005/04/16 19:33:25 asnepvangers Exp $

unit JvQDynControlEngineTools;
...
uses
  ...
  Classes, QControls, QStdCtrls, QForms, QExtCtrls,
  JvQDynControlEngine;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQDynControlEngineTools.pas,v $';
    Revision: '$Revision: 1.2 $';
    Date: '$Date: 2005/04/16 19:33:25 $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
