...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQID3v2DefineForm.pas,v 1.1 2004/12/04 00:37:03 asnepvangers Exp $

unit JvQID3v2DefineForm;
...
uses
  SysUtils, Classes, QWindows, QMessages, QGraphics, QControls, QForms, QDialogs, QStdCtrls, 
  DesignEditors, DesignIntf, DesignMenus, QDesignWindows, 
  JvQID3v2Base, JvQID3v2Types, JvQComponent;
