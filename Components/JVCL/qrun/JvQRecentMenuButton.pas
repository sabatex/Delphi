...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQRecentMenuButton.pas,v 1.1 2004/05/15 21:48:56 asnepvangers Exp $

{$I jvcl.inc}
{$I windowsonly.inc}

unit JvQRecentMenuButton;

interface

uses
  Windows, ShellApi, SysUtils, Classes,
  Types, QGraphics, QControls, QStdCtrls, QMenus,
  JvQButton, JvQComputerInfoEx, JvQTypes, JvQJVCLUtils;
