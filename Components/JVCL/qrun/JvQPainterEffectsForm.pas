...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQPainterEffectsForm.pas,v 1.15 2005/04/16 19:33:35 asnepvangers Exp $

unit JvQPainterEffectsForm;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQPainterEffectsForm.pas,v $';
    Revision: '$Revision: 1.15 $';
    Date: '$Date: 2005/04/16 19:33:35 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
