...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQDBRemoteLogin.pas,v 1.1 2004/12/04 00:26:03 asnepvangers Exp $

unit JvQDBRemoteLogin;
...
uses
  SysUtils, QWindows, QMessages, Classes, QGraphics, QControls, QForms,
  QDialogs, DBClient,
  JvQLoginForm;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQDBRemoteLogin.pas,v $';
