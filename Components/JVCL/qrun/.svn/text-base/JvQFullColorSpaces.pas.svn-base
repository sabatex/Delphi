...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQFullColorSpaces.pas,v 1.4 2005/11/01 20:47:11 asnepvangers Exp $

// TColorBox is implemented in ExtCtrls in Delphi and BCB version 6 and +

unit JvQFullColorSpaces;
...
uses
  ...
  QWindows, Classes, SysUtils, QGraphics,
  JvQTypes;
...
uses 
  QControls, QStdCtrls, QExtCtrls, 
  JvQResources, TypInfo, JvQJCLUtils ,JvQJVCLUtils, 
  Math;
