...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQInstallLabel.pas,v 1.15 2005/04/16 19:33:29 asnepvangers Exp $

unit JvQInstallLabel;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQInstallLabel.pas,v $';
    Revision: '$Revision: 1.15 $';
    Date: '$Date: 2005/04/16 19:33:29 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
...
uses
  JvQTypes, JvQThemes, JvQJVCLUtils, JvQResources;
