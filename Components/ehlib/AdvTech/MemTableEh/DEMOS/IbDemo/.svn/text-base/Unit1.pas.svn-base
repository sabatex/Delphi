...
type
  TForm1 = class(TForm)
    ...
    Button1: TButton;
    Button2: TButton;
    procedure BDEDataDriverIBBuildDataStruct(DataStruct: TMTDataStructEh);
    procedure BDEDataDriverIBUpdateError(MemTableData: TMemTableDataEh;
      MemRec: TMemoryRecordEh; var Action: TUpdateErrorActionEh);
    procedure BDEDataDriverIBUpdateRecord(MemTableData: TMemTableDataEh;
...
procedure TForm1.BDEDataDriverIBBuildDataStruct(
...
procedure TForm1.BDEDataDriverIBUpdateError(MemTableData: TMemTableDataEh;
  MemRec: TMemoryRecordEh; var Action: TUpdateErrorActionEh);
begin
  Action := ueaCountinueEh;
end;

procedure TForm1.BDEDataDriverIBUpdateRecord(MemTableData: TMemTableDataEh;
  MemRec: TMemoryRecordEh);
begin
