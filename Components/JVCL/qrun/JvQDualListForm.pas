...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQDualListForm.pas,v 1.17 2005/11/01 20:47:11 asnepvangers Exp $

unit JvQDualListForm;
...
uses
  ...
  QWindows, Classes, QGraphics, QControls, QForms, QStdCtrls, QExtCtrls, 
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQDualListForm.pas,v $';
