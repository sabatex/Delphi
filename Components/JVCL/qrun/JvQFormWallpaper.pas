...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQFormWallpaper.pas,v 1.13 2005/04/16 19:33:27 asnepvangers Exp $

unit JvQFormWallpaper;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQFormWallpaper.pas,v $';
    Revision: '$Revision: 1.13 $';
    Date: '$Date: 2005/04/16 19:33:27 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
