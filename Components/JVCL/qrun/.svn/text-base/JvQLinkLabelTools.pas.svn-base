...
-----------------------------------------------------------------------------}
// $Id: JvQLinkLabelTools.pas,v 1.16 2005/04/16 19:33:31 asnepvangers Exp $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQLinkLabelTools.pas,v $';
    Revision: '$Revision: 1.16 $';
    Date: '$Date: 2005/04/16 19:33:31 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
