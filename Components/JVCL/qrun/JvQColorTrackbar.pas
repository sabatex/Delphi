...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQColorTrackbar.pas,v 1.24 2005/10/27 20:31:22 obones Exp $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQColorTrackbar.pas,v $';
    Revision: '$Revision: 1.24 $';
    Date: '$Date: 2005/10/27 20:31:22 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
