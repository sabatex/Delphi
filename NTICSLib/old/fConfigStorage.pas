...
uses
  ...
  StdCtrls, Buttons, ExtCtrls,ComCtrls, ToolWin, inifiles, Variants;
...
implementation
uses QLowLevelFunction, ntics_classes, crypto_keys, DCPBase64, DCPgost,
     DCPblockciphers,  DCPHaval;
var
