...
-----------------------------------------------------------------------------}
// $Id: JvQProfilerForm.pas,v 1.16 2005/04/16 19:33:37 asnepvangers Exp $
...
uses
  ...
  Classes, QWindows, QDialogs, QComCtrls, QStdCtrls, QControls, QExtCtrls, QForms,
  JvQComponent;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQProfilerForm.pas,v $';
