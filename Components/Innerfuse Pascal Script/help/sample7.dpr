...
begin
  ...
  IFPSDynArraySetLength(PIFPSVariantDynamicArray(n).Data, PIFPSVariantDynamicArray(n).VI.FType, 2); // Put two items in the array
  TStringArr(PIFPSVariantDynamicArray(n).Data^)[0] := 'First item';
  TStringArr(PIFPSVariantDynamicArray(n).Data^)[1] := 'Second item';
