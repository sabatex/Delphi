...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQJVCLUtils.pas,v 1.42 2005/11/01 20:47:11 asnepvangers Exp $
...
uses
  ...
  JvQJCLUtils, JvQAppStorage, JvQTypes;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQJVCLUtils.pas,v $';
...
function CheckTaskWindow(Window: Windows.HWND; Data: Longint): LongBool; stdcall;
begin
  Result := True; 
