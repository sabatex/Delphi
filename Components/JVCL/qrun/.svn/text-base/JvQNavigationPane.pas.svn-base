...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQNavigationPane.pas,v 1.38 2005/11/01 20:47:11 asnepvangers Exp $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQNavigationPane.pas,v $';
...
begin
  ...
  begin
    ...
    TCustomImageListEx(Images).Draw(Canvas, X, Y, ImageIndex,  itImage,  True);
  end;
end;
