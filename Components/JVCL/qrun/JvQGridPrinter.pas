...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQGridPrinter.pas,v 1.13 2005/04/16 19:33:28 asnepvangers Exp $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQGridPrinter.pas,v $';
    Revision: '$Revision: 1.13 $';
    Date: '$Date: 2005/04/16 19:33:28 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
...
uses
  JvQGridPreviewForm, JvQTypes, JvQResources;
