...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQFormAnimatedIcon.pas,v 1.13 2005/04/16 19:33:26 asnepvangers Exp $

unit JvQFormAnimatedIcon;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQFormAnimatedIcon.pas,v $';
    Revision: '$Revision: 1.13 $';
    Date: '$Date: 2005/04/16 19:33:26 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
