...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQFullColorCtrls.pas,v 1.4 2005/11/01 20:47:11 asnepvangers Exp $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQFullColorCtrls.pas,v $';
...
procedure TJvFullColorAxisCombo.CreateWidget;
begin
  inherited CreateWidget;
  MakeList;
end;
...
procedure TJvFullColorGroup.CMMouseLeave(var Msg: TWMMouse);
begin
  FMouseIndex := -1;
  Msg.Result := 1;
  Refresh;
