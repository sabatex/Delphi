...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQDBQueryParamsForm.pas,v 1.2 2005/02/06 14:06:04 asnepvangers Exp $

unit JvQDBQueryParamsForm;
...
uses
  SysUtils, Classes, QControls, QForms, QStdCtrls, DB,
  JvQComponent;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQDBQueryParamsForm.pas,v $';
