...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQWizard.pas,v 1.32 2005/11/01 20:47:12 asnepvangers Exp $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQWizard.pas,v $';
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          AImages.Draw(ACanvas, ImageRect.Left, ImageRect.Top, FImageIndex );
        end;
      end;
      { YW - Draw Title }
