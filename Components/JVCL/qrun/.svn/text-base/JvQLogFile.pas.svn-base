...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQLogFile.pas,v 1.21 2005/04/16 19:33:32 asnepvangers Exp $
...
uses
  ...
  SysUtils, Classes, QControls, QForms, Contnrs,
  JvQComponent;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQLogFile.pas,v $';
    Revision: '$Revision: 1.21 $';
    Date: '$Date: 2005/04/16 19:33:32 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
