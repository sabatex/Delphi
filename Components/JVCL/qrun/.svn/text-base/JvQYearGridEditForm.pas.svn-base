...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQYearGridEditForm.pas,v 1.15 2005/04/16 19:33:59 asnepvangers Exp $

unit JvQYearGridEditForm;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQYearGridEditForm.pas,v $';
    Revision: '$Revision: 1.15 $';
    Date: '$Date: 2005/04/16 19:33:59 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
