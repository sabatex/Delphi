...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQParameterListTools.pas,v 1.2 2005/04/16 19:33:36 asnepvangers Exp $

unit JvQParameterListTools;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQParameterListTools.pas,v $';
    Revision: '$Revision: 1.2 $';
    Date: '$Date: 2005/04/16 19:33:36 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
...
uses
  Classes, SysUtils,
  JvQParameterList, JvQParameterListParameter, JvQResources;
