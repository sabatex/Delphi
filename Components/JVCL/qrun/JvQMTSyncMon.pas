...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQMTSyncMon.pas,v 1.16 2005/04/16 19:33:33 asnepvangers Exp $
...
uses 
  ...
  JvQMTThreading, JvQMTSync, JvQMTConsts;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$RCSfile: JvQMTSyncMon.pas,v $';
    Revision: '$Revision: 1.16 $';
    Date: '$Date: 2005/04/16 19:33:33 $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
