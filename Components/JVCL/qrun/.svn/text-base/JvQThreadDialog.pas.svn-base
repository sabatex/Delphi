...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvQThreadDialog.pas,v 1.4 2005/11/01 20:47:12 asnepvangers Exp $
...
uses
  QDialogs,
  JvQThread, JvQResources, QGraphics;
...
begin
  ...
  begin
    ...
    MainPanel := TPanel.Create(ThreadStatusDialog);
...
//      OldCreateOrder := False;
    ...
    begin
      ...
      Height := 22;
      Alignment := taCenter;
      FInfoTextPanel.Height := Height + 6;
      Align := alClient;
      AutoSize := False; 
      //BevelInner := bvNone;
      //BevelOuter := bvNone;
