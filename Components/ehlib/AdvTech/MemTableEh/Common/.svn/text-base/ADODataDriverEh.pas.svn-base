...
{                     EhLib vX.X                        }
{                                                       }
{         TADODataDriverEh component (Build 14)         }
{                                                       }
...
function TADODataDriverEh.CreateInsertCommand: TCustomSQLCommandEh;
begin
  Result := TADOCommandEh.Create(Self);
end;

function TADODataDriverEh.CreateSelectCommand: TCustomSQLCommandEh;
begin
  Result := TADOCommandEh.Create(Self);
end;

function TADODataDriverEh.CreateGetrecCommand: TCustomSQLCommandEh;
begin
  Result := TADOCommandEh.Create(Self);
end;

function TADODataDriverEh.CreateUpdateCommand: TCustomSQLCommandEh;
begin
  Result := TADOCommandEh.Create(Self);
end;

function TADODataDriverEh.CreateDeleteCommand: TCustomSQLCommandEh;
begin
  Result := TADOCommandEh.Create(Self);
end;
